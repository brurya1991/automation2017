...
public class ContactUsPage implements IWebsiteTest{
	...
	private String email = "meyer@gmail.com";
	...
	public void testSite()throws Exception{
		...
		GeneralTools.sleep();
		GeneralTools.throwFailure(GeneralTools.getElement(driver,submitMsgXpath).getText().equals("Message Sent Successfully"), 
				"text is: " + GeneralTools.getElement(driver,submitMsgXpath).getText() + " as expected.",
				"text is: " + GeneralTools.getElement(driver,submitMsgXpath).getText() + " .Expected is: Message Sent Successfully");
